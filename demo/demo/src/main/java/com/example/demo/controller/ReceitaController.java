...
public class ReceitaController {
    ...
    @PostMapping
    public ResponseEntity<ReceitaResponseDTO> createReceita(@RequestBody ReceitaRequestDTO receitaDTO) {
        ...
        return new ResponseEntity<>(new ReceitaResponseDTO(savedReceita), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<ReceitaResponseDTO> updateReceita(
            ...
            @RequestBody ReceitaRequestDTO receitaDTO) {
